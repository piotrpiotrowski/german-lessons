...
import {possessivePronouns} from './possessive-pronouns.datasource';
import {of} from 'rxjs';
...
export class PossessivePronounsService implements FinderService<TrainingRowModel> {
  ...
  private finderService = new MatrixFinderService<TrainingRowModel>(possessivePronouns, (columns) =>
    of(new TrainingRowModel(new Map<Language, string>([[Language.ENGLISH, columns[0]], [Language.POLISH, columns[1]], [Language.GERMAN, columns[7]]]),
      +columns[6], [
